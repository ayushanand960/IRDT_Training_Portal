...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final FocusNode dateOfJoiningFocus = FocusNode();
  ...
  bool _validatePage2() {
    ...
    // Date of Joining
    if (dateOfJoiningController.text.isEmpty) {
      FocusScope.of(context).requestFocus(dateOfJoiningFocus);
      scrollToField(dateOfJoiningFocus);
      return false;
    }
