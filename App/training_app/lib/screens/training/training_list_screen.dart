...
//     return _filteredTrainings.where((t) {
...
//                 const SizedBox(width: 4),
//                 Expanded(child: Text(training['faculty_name_display'] ?? "-")),
//               ],
//             ),
//             const SizedBox(height: 4),
//             Row(
...
//                 const SizedBox(width: 4),
//                 Text("Participants: ${training['participants'] ?? 'N/A'}"),
//               ],
//             ),
//             const SizedBox(height: 4),
//             Row(
...
//   Widget _buildTrainingSection(String title, List<dynamic> trainings) {
...
//           ),
//         ),
//         ...trainings.map(_buildTrainingCard).toList(),
//       ],
//     );
//   }
...
//                     _upcomingTrainings,
//                   ),
//                   _buildTrainingSection("Past Trainings", _pastTrainings),
...
//                   const SizedBox(width: 4),
//                   Expanded(
//                     child: Text(training['faculty_name_display'] ?? "-"),
//                   ),
//                 ],
//               ),
//               const SizedBox(height: 4),
