...
//     link.href = certificate.certificate_file;
//     link.download = `certificate_${certificate.training.code}.pdf`;
//     link.click();
//   };
...
//               >
//                 <div>
//                   <strong>{cert.training.name}</strong><br />
//                   <small>{cert.training.start_date} to {cert.training.end_date}</small>
//                 </div>
