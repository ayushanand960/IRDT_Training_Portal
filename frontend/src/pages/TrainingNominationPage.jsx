        ...
        <Col md={8}>
          <Card className="mb-4 shadow-sm">
            <Card.Body>
              ...
              <div className="text-end">
                <Button variant="outline-secondary" size="sm" onClick={handleShowAllUsers}>Show All Users</Button>
              </div>
              <hr />
              <h5>Available Trainees</h5>
              <Row className="mb-3">
                    ...
                    <Row className="align-items-center">
                      ...
                      <Col md={2} className="text-end">
                        {isAlreadyNominated(trainee.ehrms_code) ? (
                          ...
                          <>
                            <Button size="sm" variant="success" onClick={() => handleNominate(trainee)} className="me-2">Nominate</Button>
                ...
                <ListGroup as="ol" numbered>
                  {nominated.map((trainee) => (
                    <ListGroup.Item key={trainee.ehrms_code} as="li" className="d-flex justify-content-between align-items-start">
                      ...
                      <Button size="sm" variant="danger" onClick={() => handleRemove(trainee.ehrms_code)}>Remove</Button>
                    </ListGroup.Item>
                  ))}
                </ListGroup>
              )}
